...
CREATE TABLE IF NOT EXISTS evaluation_results (
  ...
  precision_at_50 REAL NOT NULL,
  precision_at_100 REAL NOT NULL,
  recall REAL NOT NULL,
  median_lead_time_days REAL,
  cost_per_verified_lead REAL,
  signal_ablation_results JSON NOT NULL DEFAULT '[]',
  geographic_coverage JSON NOT NULL DEFAULT '[]',
  created_at TEXT NOT NULL DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS lead_evaluations (
  ...
  is_true_positive INTEGER NOT NULL DEFAULT 0,
